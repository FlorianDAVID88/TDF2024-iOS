...
struct Equipe {
    ...
    static var allCases = [
        Equipe(nom_equipe: "Jumbo-Visma", abrev_equipe: "TJV", pays: .PB),
        ...
        Equipe(nom_equipe: "Movistar Team", abrev_equipe: "MOV", pays: .Espagne),
        ...
        Equipe(nom_equipe: "EF Education - EasyPost", abrev_equipe: "EFE", pays: .USA),
        Equipe(nom_equipe: "Total Énergies", abrev_equipe: "TEN", pays: .France),
        Equipe(nom_equipe: "Trek-Segafredo", abrev_equipe: "TFS", pays: .USA),
    ...
    mutating func equalsTo(equipe: Equipe) -> Bool {
        return self.id_equipe == equipe.id_equipe && self.nom_equipe == equipe.nom_equipe && self.abrev_equipe == equipe.abrev_equipe && self.pays == equipe.pays
    }
}
